...
const UpdatesManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingUpdate) {
        await updatesService.update(editingUpdate.id, formData);
      } else {
        await updatesService.create(formData);
      }
      await fetchUpdates();
      handleCloseModal();
    } catch (error) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                {editingUpdate ? t('content.editUpdate') : t('content.addUpdate')}
              </h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                  {editingUpdate ? t('common.update') : t('common.create')}
                </button>
              </div>
            </form>
          </div>
